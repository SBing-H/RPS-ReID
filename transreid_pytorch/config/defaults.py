...
_C.MODEL.EXTRA_DROP_PATH = False
_C.MODEL.EXTRA_DROP_PATH_LAYERS = [11]
_C.MODEL.NGTSE = False
_C.MODEL.NGTSE_MODE = 'token'
_C.MODEL.NGTSE_LAYERS = [11]
_C.MODEL.NGTSE_KERNEL = 5
_C.MODEL.NGTSE_BETA = 0.25
_C.MODEL.NGTSE_GATE_TYPE = 'q'
_C.MODEL.NGTSE_DETACH_GATE = True
_C.MODEL.NGTSE_RESIDUAL_GATE = True
...
_C.DISTILL.DARK_ROOT = '../data/Syn_dark_market_msmt_v3'
_C.DISTILL.GT_ROOT = '../data/Syn_dark_market_msmt_v3_GT'
_C.DISTILL.TEACHER_WEIGHT = ''
_C.DISTILL.LAMBDA_KD = 0.02
_C.DISTILL.ALPHA = 1.0
_C.DISTILL.BETA = 0.8
